...
public class ProductController {
    ...
    @GetMapping
    public Page<ProductResponse> findAll(@RequestParam(required = false) Long categoryId, Pageable pageable) {
    ...
    @GetMapping("/skus")
    public List<String> getSkusByCategory(@RequestParam Long categoryId) {
        return productService.getSkusByCategoryId(categoryId);
    }
